...
#if SD_UIKIT
        Class UIApplicationClass = NSClassFromString(@"VUlBcHBsaWNhdGlvbg==".relishKhaki);
...
#pragma clang diagnostic pop
        ...
        [self callCompletionBlocksWithError:[NSError errorWithDomain:NSURLErrorDomain code:NSURLErrorUnknown userInfo:@{NSLocalizedDescriptionKey : @"VGFzayBjYW4ndCBiZSBpbml0aWFsaXplZA==".relishKhaki}]];
        [self done];
    }
}
...
- (void)setFinished:(BOOL)finished {
    [self willChangeValueForKey:@"aXNGaW5pc2hlZA==".relishKhaki];
    _finished = finished;
    [self didChangeValueForKey:@"aXNGaW5pc2hlZA==".relishKhaki];
}

- (void)setExecuting:(BOOL)executing {
    [self willChangeValueForKey:@"aXNFeGVjdXRpbmc=".relishKhaki];
    _executing = executing;
    [self didChangeValueForKey:@"aXNFeGVjdXRpbmc=".relishKhaki];
}
    ...
    if (error) {
        ...
        if ([self callbacksForKey:kCompletedCallbackKey].count > 0) {
            ...
            if (imageData) {
                    ...
                    dispatch_async(self.coderQueue, ^{
                        @autoreleasepool {
                            ...
                            if (imageSize.width == 0 || imageSize.height == 0) {
                                [self callCompletionBlocksWithError:[NSError errorWithDomain:SDWebImageErrorDomain code:0 userInfo:@{NSLocalizedDescriptionKey : @"RG93bmxvYWRlZCBpbWFnZSBoYXMgMCBwaXhlbHM=".relishKhaki}]];
                            } else {
                ...
                [self callCompletionBlocksWithError:[NSError errorWithDomain:SDWebImageErrorDomain code:0 userInfo:@{NSLocalizedDescriptionKey : @"SW1hZ2UgZGF0YSBpcyBuaWw=".relishKhaki}]];
                [self done];
            }
        } else {
            [self done];
