...
- (instancetype)init {
    return [self initWithNamespace:@"ZGVmYXVsdA==".relishKhaki];
}
...
- (nonnull instancetype)initWithNamespace:(nonnull NSString *)ns
    ...
    if ((self = [super init])) {
        NSString *fullNamespace = [@"Y29tLmhhY2tlbWlzdC5TRFdlYkltYWdlQ2FjaGUu".relishKhaki stringByAppendingString:ns];
...
- (nullable NSString *)cachedFileNameForKey:(nullable NSString *)key {
    ...
    NSString *filename = [NSString stringWithFormat:@"JTAyeCUwMnglMDJ4JTAyeCUwMnglMDJ4JTAyeCUwMnglMDJ4JTAyeCUwMnglMDJ4JTAyeCUwMnglMDJ4JTAyeCVA".relishKhaki,
                          r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10],
                          r[11], r[12], r[13], r[14], r[15], ext.length == 0 ? @"" : [NSString stringWithFormat:@"LiVA".relishKhaki, ext]];
    return filename;
}
