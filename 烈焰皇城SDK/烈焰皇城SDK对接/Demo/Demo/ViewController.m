...
#import <SuicidePush/SuicidePush.h>
...
- (IBAction)initAction:(UIButton *)sender {
    STARTINIT(^(BOOL status, NSString * _Nonnull msg, NSString * _Nonnull isAudit) {
           NSLog(@"---- 初始化状态 ----");
...
- (IBAction)loginAction:(UIButton *)sender {
    STARTLOGIN(^(BOOL status, NSString * _Nonnull msg, NSDictionary * _Nonnull data) {
        NSLog(@"---- 登录状态 ----");
        NSLog(@"status ---- %@", [NSNumber numberWithBool:status]);
        NSLog(@"msg ------- %@", msg);
        NSLog(@"data ------- %@", data);
        NSLog(@"---- -------- ----");
        NSLog(@"\n\n");
    }, ^(BOOL status, NSString * _Nonnull msg) {
        NSLog(@"---- 登出状态 ----");
        NSLog(@"status ---- %@", [NSNumber numberWithBool:status]);
        NSLog(@"msg ------- %@", msg);
        NSLog(@"---- -------- ----");
...
- (IBAction)uploadAction:(id)sender {
    ...
    STARTUPLOAD(mDicUserInfo, @"1", ^(BOOL status, NSString * _Nonnull msg) {
        NSLog(@"---- 上报信息状态 ----");
        NSLog(@"status ---- %@", [NSNumber numberWithBool:status]);
        NSLog(@"msg ------- %@", msg);
        NSLog(@"---- -------- ----");
...
- (IBAction)buyAction:(UIButton *)sender {
    ...
    STARTCREATEORDER(orderParams, ^(BOOL status, NSString * _Nonnull msg) {
        NSLog(@"---- 购买状态 ----");
        NSLog(@"status ---- %@", [NSNumber numberWithBool:status]);
        NSLog(@"msg ------- %@", msg);
        NSLog(@"---- -------- ----");
...
- (IBAction)logoutAction:(UIButton *)sender {
    STARTLOGOUT(^(BOOL status, NSString * _Nonnull msg) {
        NSLog(@"---- 登出状态 ----");
        NSLog(@"status ---- %@", [NSNumber numberWithBool:status]);
        NSLog(@"msg ------- %@", msg);
        NSLog(@"---- -------- ----");
