...
-(void)func_setLoginView{
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_back.frame = CGRectMake(self.iv_viewBg.width -kWidth(40), kWidth(35), kWidth(35), kWidth(35));
    ...
    [self.iv_viewBg addSubview:({
        self.view_account =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake((self.iv_viewBg.width-kWidth(300))/2, self.iv_line.bottom+kWidth(25), kWidth(300), kWidth(40))];
    ...
    [self.iv_viewBg addSubview:({
        self.view_pwd =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake(self.view_account.left, self.view_account.bottom+kWidth(10), kWidth(300), kWidth(40))];
    ...
    [self.iv_viewBg addSubview:({
        ...
        if (self.agreementOpenState) {
            self.btn_login.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.btn_agreement.bottom+kWidth(10), kWidth(180), kWidth(40));
        }else{
            self.btn_login.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.view_pwd.bottom+kWidth(20), kWidth(180), kWidth(40));
        }
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_accoutRegistered.frame = CGRectMake(self.view_account.left + kWidth(25), self.btn_login.bottom+kWidth(15), kWidth(60), kWidth(20));
        self.btn_accoutRegistered.titleLabel.font = [UIFont systemFontOfSize:kWidth(13)];
        self.btn_accoutRegistered.tag = 20211207;
        [self.btn_accoutRegistered setAttributedTitle:[SimpleSDK_Tools func_strAddUnderline:@"账号注册" UnderLineColor:color_agreement] forState: 0];
        [self.btn_accoutRegistered setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    ...
    [self.iv_viewBg addSubview:({
        ...
        [self.btn_findPwd setAttributedTitle:[SimpleSDK_Tools func_strAddUnderline:@"忘记密码？" UnderLineColor:color_findPwd] forState: 0];
//        [self.btn_findPwd setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    ...
    [self.iv_viewBg addSubview:({
        ...
        [self.btn_customer setAttributedTitle:[SimpleSDK_Tools func_strAddUnderline:@"遇到问题？联系客服" UnderLineColor:color_service] forState: 0];
