...
-(void)func_setWelcomeView{
    ...
    [self addSubview:({
        ...
        self.lb_weclomeName.textColor = [UIColor ZNWinObj_colorWithHexString:@"#e4cd9c"];
        NSMutableAttributedString *yiLeObj_tncString = [[NSMutableAttributedString alloc] initWithString:welcomeTip];
        [yiLeObj_tncString addAttribute:NSForegroundColorAttributeName value:[UIColor ZNWinObj_colorWithHexString:@"#02df07"] range:accountRange];
    ...
    [self addSubview:({
        ...
        self.lb_weclomeTip.textColor = [UIColor ZNWinObj_colorWithHexString:@"#e4cd9c"];
