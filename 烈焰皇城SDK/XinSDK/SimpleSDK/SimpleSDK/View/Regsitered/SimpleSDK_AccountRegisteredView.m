...
//        self.view_pwd.tf_input.secureTextEntry = YES;
    ...
    [self.iv_viewBg addSubview:({
        ...
        if (self.agreementOpenState) {
            self.btn_registered.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.btn_agreement.bottom+kWidth(10), kWidth(180), kWidth(40));
        }else{
            self.btn_registered.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.btn_toPhoneRegistered.bottom+kWidth(15), kWidth(180), kWidth(40));
        }
