...
-(void)func_setFastRegisteredView{
    ...
    [self.iv_viewBg addSubview:({
        self.view_account =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake((self.iv_viewBg.width-kWidth(300))/2, self.iv_line.bottom+kWidth(30), kWidth(300), kWidth(35))];
    ...
    [self.iv_viewBg addSubview:({
        ...
        if (self.agreementOpenState) {
            ...
            self.btn_regsitered.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.btn_agreement.bottom+kWidth(20), kWidth(180), kWidth(40));
            
        }else {
            
            self.btn_regsitered.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.view_pwd.bottom+kWidth(30), kWidth(180), kWidth(40));
        }
