...
-(void)func_setPhoneRegisteredView{
    ...
    [self.iv_viewBg addSubview:({
        self.view_code =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake(self.view_phone.left, self.view_phone.bottom+kWidth(15), kWidth(300), kWidth(35))];
    ...
    [self.iv_viewBg addSubview:({
        ...
        if (self.agreementOpenState) {
            self.btn_regsiteredOrLogin.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.btn_agreement.bottom+kWidth(20), kWidth(180), kWidth(40));
        }else{
            self.btn_regsiteredOrLogin.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.view_code.bottom+kWidth(25), kWidth(180), kWidth(40));
        }
