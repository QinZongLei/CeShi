...
-(void)func_setScreenshotsView{
    self.titleStr = @"注册成功";
    self.lb_title.frame = CGRectMake((self.iv_viewBg.width-kWidth(120))/2, kWidth(70), kWidth(120), kWidth(30));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.lb_savePrompt.textColor = color_agreement_tip;
        self.lb_savePrompt;
    })];
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.lb_saveWarning.textColor = color_agreement_tip;
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.lb_closeTime.textColor = RGBHEX(0x67A7B2);
