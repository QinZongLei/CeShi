...
-(void)func_setUpdatePhonePwdView{
    ...
    [self.iv_viewBg addSubview:({
        self.view_phone =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake((self.iv_viewBg.width-kWidth(300))/2, self.iv_line.bottom+kWidth(20), kWidth(300), kWidth(35))];
    ...
    [self.iv_viewBg addSubview:({
        self.view_code =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake(self.view_phone.left, self.view_phone.bottom+kWidth(10), kWidth(300), kWidth(35))];
        //添加获取验证码按钮
...
//        self.view_determinePwd.centerX = self.iv_viewBg.centerX-kWidth(15);
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_updatePwd.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.view_determinePwd.bottom+kWidth(20), kWidth(180), kWidth(40));
