...
-(void)func_setUserCenterView{
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.iv_userImg.frame = CGRectMake(kWidth(65), kWidth(70), kWidth(50), kWidth(50));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.lb_userName.frame = CGRectMake(self.iv_userImg.right+kWidth(5), self.iv_userImg.top+kWidth(5), kWidth(200), kWidth(20));
    ...
    [self.iv_viewBg addSubview:({
        ...
        [self.btn_publcCode setAttributedTitle:[SimpleSDK_Tools func_strAddUnderline:@"关注公众号：更多福利活动等您来参与" UnderLineColor:color_idCrad_tip] forState: 0];
        [self.btn_publcCode setTitleColor:color_idCrad_tip forState:UIControlStateNormal];
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_switchAccount.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.btn_publcCode.bottom+kWidth(10), kWidth(180), kWidth(40));
