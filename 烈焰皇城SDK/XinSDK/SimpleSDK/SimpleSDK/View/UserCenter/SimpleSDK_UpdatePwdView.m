...
-(void)func_setUpdatePwdView{
    ...
    [self.iv_viewBg addSubview:({
        self.view_oldPwd =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake((self.iv_viewBg.width-kWidth(300))/2, self.iv_line.bottom+kWidth(25), kWidth(300), kWidth(35))];
        self.view_oldPwd.iconPath = kSetBundleImage(inputPwdIcon);
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.view_newPwd.iconPath = kSetBundleImage(inputPwdIcon);
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_updatePwd.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.view_determinePwd.bottom+kWidth(15), kWidth(180), kWidth(40));
