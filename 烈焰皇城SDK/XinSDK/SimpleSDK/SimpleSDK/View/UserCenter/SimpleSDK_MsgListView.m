...
-(void)func_setMsgListView{
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.tb_msgList.separatorColor = [UIColor colorWithRed:170.0/255.0 green:220.0/255.0  blue:229.0/255.0  alpha:1.0];
        if (self.msgDic.count >0) {
            ...
            self.tb_msgList.rowHeight = self.iv_viewBg.height - kWidth(105);
        ...
        self.tb_msgList.frame = CGRectMake((self.iv_viewBg.width-(self.iv_viewBg.width-kWidth(40)))/2, self.iv_line.bottom+kWidth(10), self.iv_viewBg.width-kWidth(40), self.iv_viewBg.height- kWidth(105));
//        self.tb_msgList.centerX  = self.iv_viewBg.centerX -kWidth(15);
        self.tb_msgList;
    })];
}
