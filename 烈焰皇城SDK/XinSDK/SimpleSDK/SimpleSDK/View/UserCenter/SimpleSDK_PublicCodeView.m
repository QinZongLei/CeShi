...
-(void)func_setPublicCodeView{
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.lb_prompt.textColor = color_agreement_tip;
        self.lb_prompt.font = [UIFont systemFontOfSize:kWidth(16)];
        self.lb_prompt.textAlignment = NSTextAlignmentCenter;
        self.lb_prompt.frame = CGRectMake((self.iv_viewBg.width-kWidth(260))/2, self.iv_line.bottom + kWidth(10), kWidth(260), kWidth(20));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.iv_codeImg.frame = CGRectMake((self.iv_viewBg.width-kWidth(100))/2, self.lb_prompt.bottom+kWidth(10), kWidth(100), kWidth(100));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.lb_codeName.textColor = [UIColor ZNWinObj_colorWithHexString:@"#da8703"];
        self.lb_codeName.frame = CGRectMake((self.iv_viewBg.width-kWidth(300))/2, self.iv_codeImg.bottom+kWidth(10), kWidth(300), kWidth(20));
//        self.lb_codeName.centerX = self.iv_viewBg.centerX - kWidth(15);
        self.lb_codeName;
    })];
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_copyImg.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.lb_codeName.bottom+kWidth(10), kWidth(180), kWidth(40));
        self.btn_copyImg.tag = 20211202;
//        self.btn_copyImg.centerX = self.iv_viewBg.centerX - kWidth(15);
        self.btn_copyImg;
    })];
}
