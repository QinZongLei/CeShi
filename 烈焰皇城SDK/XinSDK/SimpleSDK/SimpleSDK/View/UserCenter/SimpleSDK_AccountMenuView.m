...
-(void)func_setAccountMenuView{
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.tb_menuList.frame = CGRectMake((self.iv_viewBg.width- (self.iv_viewBg.width-kWidth(60)))/2, self.iv_line.bottom + kWidth(20), self.iv_viewBg.width-kWidth(60), kWidth(155));
//        self.tb_menuList.centerX = self.iv_viewBg.centerX-kWidth(15);
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_switchAccount.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.tb_menuList.bottom+kWidth(10), kWidth(180), kWidth(40));
