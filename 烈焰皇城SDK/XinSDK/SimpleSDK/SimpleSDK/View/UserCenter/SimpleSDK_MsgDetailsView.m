...
-(void)func_setMsgDetailsView{
    self.titleStr =@"公告详情";
    self.lb_title.frame = CGRectMake((self.iv_viewBg.width-kWidth(120))/2, kWidth(70), kWidth(120), kWidth(20));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.tv_content.textColor = color_agreement_tip;
        self.tv_content.backgroundColor = [UIColor clearColor];
        self.tv_content.delegate = self;
        self.tv_content.editable = YES;
        self.tv_content.frame = CGRectMake(kWidth(50), self.lb_title.bottom+kWidth(5), self.iv_viewBg.width - kWidth(90), kWidth(100));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.iv_publicCode.frame =  CGRectMake((self.iv_viewBg.width-kWidth(100))/2, self.tv_content.bottom+kWidth(5), kWidth(100), kWidth(100));
...
- (void)setDetailedDict:(NSMutableDictionary *)detailedDict{
    ...
    if (!kStringIsNull(codeUrl)) {
        ...
        self.tv_content.frame = CGRectMake(kWidth(50), self.lb_title.bottom+kWidth(5), self.iv_viewBg.width - kWidth(90), kWidth(180));;
//        self.tv_content.centerX = self.iv_viewBg.centerX -kWidth(15);
