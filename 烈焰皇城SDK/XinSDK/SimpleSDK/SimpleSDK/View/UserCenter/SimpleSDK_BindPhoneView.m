...
-(void)func_setBindPhoneView{
    ...
    [self.iv_viewBg addSubview:({
        self.view_phone =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake((self.iv_viewBg.width-kWidth(300))/2, self.iv_line.bottom+kWidth(30), kWidth(300), kWidth(35))];
    ...
    [self.iv_viewBg addSubview:({
        self.view_code =[[SimpleSDK_CustomUITextFieldView alloc] initWithFrame:CGRectMake(self.view_phone.left, self.view_phone.bottom+kWidth(20), kWidth(300), kWidth(35))];
        //添加获取验证码按钮
        ...
        self.btn_getCode.tag = 20211203;
        self.btn_getCode.frame = CGRectMake(self.view_code.iv_viewBg.width-kWidth(80),0, kWidth(75), kWidth(25));
...
//        self.view_code.centerX = self.iv_viewBg.centerX-kWidth(15);
        self.view_code;
    })];
    
    [self.iv_viewBg addSubview:({
        self.btn_bindPhone = [UIButton buttonWithType:UIButtonTypeCustom];
        self.btn_bindPhone.frame = CGRectMake((self.iv_viewBg.width-kWidth(150))/2, self.view_code.bottom+kWidth(30), kWidth(180), kWidth(40));
//        self.btn_bindPhone.centerX = self.iv_viewBg.centerX-kWidth(15);
