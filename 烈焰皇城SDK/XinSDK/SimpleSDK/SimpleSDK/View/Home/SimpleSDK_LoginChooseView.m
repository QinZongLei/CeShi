...
-(void)func_setLoginChonseView{
    ...
    [self.view addSubview:({
        ...
        self.iv_viewBg.frame = CGRectMake(0, 0, kWidth(400), kWidth(230));
    ...
    [self.iv_viewBg addSubview:({
        ...
        self.btn_phoneLogin.titleLabel.font = [UIFont systemFontOfSize:kWidth(15)];
        self.btn_phoneLogin.tag = 20211201;
        self.btn_phoneLogin.frame = CGRectMake((self.iv_viewBg.width - kWidth(40))/2, self.iv_viewBg.height/2- kWidth(35), kWidth(60), kWidth(60));
        self.btn_phoneLogin.titleEdgeInsets =  UIEdgeInsetsMake(kWidth(5), kWidth(-18), kWidth(-90), kWidth(-20));
        [self.btn_phoneLogin setTitle:@"手机登陆" forState:0];
    ...
    [self.iv_viewBg addSubview:({
        ...
        [self.btn_acountLogin setTitle:@"账号登陆" forState:UIControlStateNormal];
